...
//             />
//             <h3 className="font-normal text-[16px] text-[#254154] mb-2">{vehicleName}</h3>
...
//         <div className="border border-[#E0E8ED] rounded-lg p-3 relative h-full">
...
//         <div className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300 p-2">
...
//             </div>
//             <div className="p-4">
//                 <h3 className="font-semibold text-[16px] text-[#254154] mb-2">{name}</h3>
//                 <p className="text-[14px] text-[#000000] mb-4">{price}</p>
//                 <button
...
//                         <div>
//                                                      <h2 className='font-bold md:text-[24px] text-lg  capitalize'>{categoryData[0]?.productName} Tata Intra V50 </h2>
...
//                         </div>
//                                              <div>
//                                                      <h2 className='font-bold md:text-[24px] text-lg  capitalize'>{categoryData[0]?.productName} Tata Intra V30 </h2>
//                         <div className='bg-[#EEFFEB] p-5 rounded-md md:mt-5'>
//                             <div className='flex items-center gap-2 mb-5'>
//                                 <img src="/icons/like.svg" alt="like" />
//                                 <p className='font-bold text-base'>Pros</p>
...
//                 {/* Banner Section */}
//                 <div className="w-full h-32 bg-gradient-to-r from-yellow-400 to-yellow-600 rounded-lg mb-10 relative overflow-hidden">
