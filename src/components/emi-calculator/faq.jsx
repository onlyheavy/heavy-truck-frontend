...
export default function Faq() {
    ...
    return (
        <div className="bg-white md:py-10 py-4 md:px-16 px-0 pt-10">
            <h2 className="font-bold md:text-[24px] text-[18px] leading-[20px] text-[#000000] text-center md:mb-10 mb-6">
