        ...
        <>
            <div className="relative h-96 bg-[url('/fuel-banner.png')] bg-cover bg-center">
                <div className='absolute inset-0 bg-gradient-to-r from-black/90 to-white/60'>
                    ...
                    <p className='text-gray-300 text-2xl py-12 font-light px-20 w-[65%]'>Easily estimate your monthly and yearly fuel expenses. Enter distance, mileage, and fuel price to track your costs and save smarter.</p>
                </div>
            </div>
        </>
    )
