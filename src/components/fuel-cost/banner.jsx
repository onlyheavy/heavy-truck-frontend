...
const Banner = () => {
    return (
        <>
            ...
            <div className=" h-52 md:h-96 bg-[url('/fuel-banner.png')] bg-cover bg-[position:80%_center] relative">
                <div className='absolute inset-0 bg-gradient-to-r from-black/70 to-white/40'>
